...
public class ConstantUtil {
	 ...
	 */
	//初始化
	public static String APP_ID = "wx5182c28c4165e637";//微信开发平台应用id
	public static String APP_SECRET = "abad86e292de8d5ced1afa1ceac464b6";//应用对应的凭证
	public static String PARTNER = "1402633302";//财付通商户号
	public static String PARTNER_KEY = "dongnengdongnengdongnengdongneng";//商户号对应的密钥
