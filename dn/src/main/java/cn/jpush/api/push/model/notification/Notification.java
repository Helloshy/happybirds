...
public class Notification implements PushModel {    
     ...
     * shortcut
     */
    public static Notification android(String alert, String title, Map<String, Object> extras) {
        return newBuilder()
     ...
     * shortcut
     */
    public static Notification ios(String alert, Map<String, Object> extras) {
        return newBuilder()
     ...
     * shortcut
     */
    public static Notification winphone(String alert, Map<String, Object> extras) {
        return newBuilder()
