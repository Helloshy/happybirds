...
public abstract class PlatformNotification implements PushModel {
    ...
    public PlatformNotification(String alert, Map<String, Object> extras, 
    ...
    protected abstract static class Builder<T> {
        ...
        protected Map<String, Object> extrasBuilder;
        ...
        public Builder<T> addExtra(String key, String value) {
            ...
            if (null == extrasBuilder) {
                extrasBuilder = new HashMap<String, Object>();
            }
            extrasBuilder.put(key, value);
            return this;
        }

        public Builder<T> addExtras(Map<String, Object> extras) {
            if (null == extras) {
