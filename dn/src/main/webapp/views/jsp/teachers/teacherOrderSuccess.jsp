...
<body>
	...
	<div id="gridTools" data-options="border:false" style="padding-top: 10px;">
		...
		<span>状态：<input type="text" id="state-3" name="state" style="width: 100px"/></span>
	...
	<table id="mygrid" style="margin-top: 10px;display: none;width: 115%" class="myResize"
		data-options="url:'<%=thisPath %>searchList.htm?recordType=1&type=2',loadFilter:loadFilter,nowrap:false,
