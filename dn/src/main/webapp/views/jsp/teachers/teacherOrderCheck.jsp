...
<body>
	...
	<div id="gridTools" data-options="border:false" style="padding-top: 10px;">
		...
		<span style="margin-left: 30px;">预约订单号：<input type="text" name="id" class="easyui-textbox" style="width: 100px"/></span>
		...
		<a href="javascript:void(0)" title="批量取消数据" style="margin-left: 30px;" class="easyui-linkbutton" data-options="iconCls:'icon-remove'" onclick="state(3)">取消</a>
	...
	<table id="mygrid" style="margin-top: 10px;display: none;width: 115%" class="myResize"
		data-options="url:'<%=thisPath %>searchList.htm?recordType=1&type=0&uid=<%=uid %>',loadFilter:loadFilter,nowrap:false,
		fitColumns:true,animate: true,showFooter: false,onLoadSuccess:gridLoadSuccess,pagination:true,loading:true,rownumbers:true">
		<thead>
			<tr>
				<th data-options="field:'ck',checkbox:true"></th>
				<th data-options="field:'id',width:6,align:'center'">预约订单号</th>
				...
				<th data-options="field:'teachStart_teachEnd',width:15,align:'center'">开始时间-结束时间</th>
				<th data-options="field:'teachTimes',width:6,align:'center'">申请讲学场数</th>
...
<div id="add-dialog" style="width: 850px;height: 650px;" class="easyui-dialog" class="easyui-dialog"  data-options="iconCls:'icon-save',resizable:true,modal:true,
	...
	<table class="mf-table">
		...
		<tr class="mf-line">
			...
			<td class="mf-right">
				<input type="text" id="nickName" name="nickName" class="easyui-textbox" data-options="required:true" style="width: 150px"/>
			</td>
			<td class="mf-left">联系电话</td>
			<td class="mf-right">
				<input type="text" id="phone" name="phone" class="easyui-textbox" data-options="required:true" style="width: 150px"/>
			</td>
			<td class="mf-left">预约订单号</td>
			<td class="mf-right" id="orderNo"></td>
		</tr>
		<tr class="mf-line">
			<td class="mf-left">讲学地点</td>
		...
		<tr class="mf-line">
			<td class="mf-left">单位名称</td>
			<td class="mf-right" colspan="2">
				<input type="text" id="companyName" name="companyName" class="easyui-textbox" data-options="required:true" style="width: 200px"/>
			</td>
			<td class="mf-left">单位简介</td>
			<td class="mf-right" colspan="2">
				<input type="text" id="companyRemark" name="companyRemark" class="easyui-textbox" data-options="required:true" style="width: 200px"/>
			</td>
		</tr>
		...
		<tr class="mf-line">
			...
			<td class="mf-right" colspan="2">
				<input type="text" id="teachEnd" name="teachEnd" class="easyui-datebox" data-options="required:true,editable:false" style="width: 200px"/>
			</td>
		</tr>
		<tr class="mf-line">
			<td class="mf-left">讲学场数</td>
			<td class="mf-right" colspan="2">
				<input type="text" id="teachTimes" name="teachTimes" class="easyui-textbox" style="width: 200px"/>
			</td>
		...
		<tr class="mf-line">
			...
			<td class="mf-right" colspan="5">
				<textarea id="remark" name="remark" cols="30" rows="5" class="textarea easyui-validatebox"></textarea>
			</td>
		</tr>
		...
		<tr class="mf-line">
			...
			<td class="mf-right" colspan="5">
				...
				&nbsp;<input type="radio" name="state" value="2"/>审核不通过
			</td>
		</tr>
	</table>
	</form>
...
<!-- 通过审核 -->
<div style="display: none;">
<div id="add-oa" style="width: 300px;height: 250px;" class="easyui-dialog" class="easyui-dialog"  data-options="iconCls:'icon-save',resizable:true,modal:true,
	...
	<table class="mf-table">
		<tr class="mf-line">
			<td class="mf-left">费用</td>
			<td class="mf-right">
				<input type="text" name="orderAmount" class="easyui-textbox" data-options="required:true" style="width: 140px"/>
			</td>
		</tr>
	</table>
	</form>
