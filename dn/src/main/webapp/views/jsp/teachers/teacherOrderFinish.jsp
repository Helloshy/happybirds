...
<body>
	...
	<table id="mygrid" style="margin-top: 10px;display: none;width: 115%" class="myResize"
		data-options="url:'<%=thisPath %>searchList.htm?recordType=1&type=3',loadFilter:loadFilter,nowrap:false,
...
<div id="add-oa" style="width: 500px;height: 450px;" class="easyui-dialog" class="easyui-dialog"  data-options="iconCls:'icon-save',resizable:true,modal:true,
	...
	<table class="mf-table">
		<tr class="mf-line">
			...
			<td class="mf-right" id="star"></td>
		</tr>
		<tr class="mf-line">
			<td class="mf-left">评价内容</td>
			<td class="mf-right">
				<textarea id="content" cols="30" rows="5" class="textarea easyui-validatebox" readonly="readonly"></textarea>
			</td>
		</tr>
		<tr class="mf-line">
