...
<body>
	...
	<table id="mygrid" style="margin-top: 10px;display: none;width: 100%" class="myResize"
		data-options="url:'<%=thisPath %>searchList.htm?recordType=2',loadFilter:loadFilter,
		fitColumns:true,animate: true,showFooter: false,onLoadSuccess:gridLoadSuccess,pagination:true,loading:true,rownumbers:true">
		<thead>
			<tr>
				<th data-options="field:'ck',checkbox:true"></th>
				<th data-options="field:'logoPath',width:10,align:'center',formatter:imageFormatter">图片</th>
				<th data-options="field:'teacherName',width:10,align:'center'">推荐名师</th>
...
<div id="add-dialog" style="width: 800px;height: 650px;" class="easyui-dialog" class="easyui-dialog"  data-options="iconCls:'icon-save',resizable:true,modal:true,
	...
	<table class="mf-table">
		<tr class="mf-line">
			...
			<td class="mf-right" colspan="3">
				 <div id="imgdiv"><img id="imgShow" width="200" height="100" /></div>
   				 <input type="file" id="up_img" name="file"/>
			</td>
		</tr>
		<tr class="mf-line">
			<td class="mf-left">推荐名师</td>
			<td class="mf-right">
				<input type="text" id="teacherId" name="teacherId" class="easyui-combobox" style="width: 150px"/>
			</td>
		</tr>
		<tr class="mf-line">
