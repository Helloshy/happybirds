...
<body>
	...
	<div id="gridTools" data-options="border:false" style="padding-top: 10px;">
		<form id="search-form" style="margin-top: 10px;text-align: center;">
			...
			<span style="margin-left: 30px;">教务名称：<input class="easyui-textbox" type="text" name="teacherName" style="width: 120px"/></span>
	...
	<table id="mygrid" style="margin-top: 10px;display: none;width: 100%" class="myResize"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'id',width:6,align:'center'">课程编号</th>
				...
				<th data-options="field:'userName',width:8,align:'center'">教务名称</th>
				<th data-options="field:'subsidy',width:8,align:'center'">教务补贴费用</th>
				<th data-options="field:'counts',width:8,align:'center'">消耗人数</th>
				<th data-options="field:'contacts',width:8,align:'center'">教务总人数</th>
