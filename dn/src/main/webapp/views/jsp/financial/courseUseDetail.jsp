...
<body>
	...
	<div id="gridTools" data-options="border:false" style="padding-top: 10px;">
		<form id="search-form" style="margin-top: 10px;text-align: center;">
			...
			<a href="javascript:void(0)" title="导出" style="margin-left: 30px;" class="easyui-linkbutton" data-options="iconCls:'icon-undo'" onClick="exportExcel(11)">导出Excel</a>
		</form>
	</div>

	<!--  数据列表datagrid    一般使用只需要配置 标题:title 数据加载url地址:url  data-options第二行配置是datagrid的默认配置 -->
	<table id="mygrid" style="margin-top: 10px;display: none;width: 100%" class="myResize"
		data-options="url:'<%=thisPath %>searchList.htm?type=11',loadFilter:loadFilter,
		fitColumns:true,animate: true,showFooter: false,onLoadSuccess:gridLoadSuccess,pagination:true,loading:true,rownumbers:true">
		<thead>
			<tr>
				<th data-options="field:'ck',checkbox:true"></th>
				<th data-options="field:'payAmount',width:6,align:'center'">月份</th>
				<th data-options="field:'userName',width:8,align:'center'">注册账号</th>
				<th data-options="field:'realName',width:8,align:'center'">真实姓名</th>
				<th data-options="field:'payMethod',width:8,align:'center'">课程名称</th>
				<th data-options="field:'discountBlue',width:6,align:'center'">已消耗课程</th>
				<th data-options="field:'discountRed',width:6,align:'center'">已消耗量</th>
				<th data-options="field:'payTime',width:8,align:'center'">已消耗总金额</th>
				<th data-options="field:'payTime',width:8,align:'center'">未消耗量</th>
				<th data-options="field:'payTime',width:8,align:'center'">未消耗总金额</th>
				<th data-options="field:'payTime',width:12,align:'center'">更新时间</th>
			</tr>
		</thead>
	</table>
