...
<div id="gridTools" data-options="border:false" style="padding-top: 10px;">
	<form id="search-form" style="margin-top: 10px;text-align: center;">
		<!-- <a href="javascript:void(0)" title="添加数据" style="margin-left: 10px;" class="easyui-linkbutton" data-options="iconCls:'icon-add'" onClick="gridAdd()">添加</a> -->
	</form>
</div>
...
<table id="mygrid" style="display: none;" class="myResize"
      data-options="url:'<%=thisPath %>searchList.htm?msgType=0',singleSelect:true,loadFilter:loadFilter,pageNumber:1,
	...
	<form id="add-data-form" target="uploadImgFrame" method="post" enctype="multipart/form-data" style="margin: 0px;padding: 0px;">
		...
		<table class="mf-table">
			...
			<tr class="mf-line"><td class="mf-left">内容：</td>
				<td class="mf-right">
					<textarea id="memo" name="memo" style="width: 100%;height: 250px" ></textarea>
