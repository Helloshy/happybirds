...
<body>
	...
	<table id="mygrid" style="display: none;width: 100%" class="myResize"
		data-options="url:'<%=thisPath %>searchList.htm?id=appointment_cancel_time',loadFilter:loadFilter,nowrap:false,
		fitColumns:true,animate: true,showFooter: false,onLoadSuccess:gridLoadSuccess,pagination:true,loading:true,rownumbers:true">
		<thead>
			<tr>
				<th data-options="field:'ck',checkbox:true"></th>
				<th data-options="field:'value',width:10,align:'center'">订单自动取消时间</th>
...
<div id="add-dialog" style="width: 350px;height: 280px;" class="easyui-dialog" class="easyui-dialog"  data-options="iconCls:'icon-save',resizable:true,modal:true,
	...
	<table class="mf-table">
		<tr class="mf-line">
			<td class="mf-left">订单自动取消时间</td>
			<td class="mf-right">
				<input type="text" id="value" name="value" class="easyui-textbox" data-options="required:true" style="width: 90px"/>
			</td>
		</tr>
	</table>
	</form>
