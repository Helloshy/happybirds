...
<table id="mygrid" style="margin-top: 10px;display: none;" class="myResize"
      data-options="url:'<%=thisPath %>searchList.htm?msgType=2',singleSelect:true,loadFilter:loadFilter,pageNumber:1,
...
<div id="add-dialog" class="easyui-dialog" style="width: 700px;height: 500px;" 
