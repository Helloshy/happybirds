...
<body>
	...
	<table id="mygrid" style="margin-top: 10px;display: none;width: 100%" class="myResize"
		data-options="url:'<%=thisPath %>searchList.htm?recordType=1',loadFilter:loadFilter,
...
<div id="add-dialog" style="width: 600px;height: 600px;" class="easyui-dialog" class="easyui-dialog"  data-options="iconCls:'icon-save',resizable:true,modal:true,
	...
	<table class="mf-table">
		...
		<tr class="mf-line">
			...
			<td class="mf-right">
				<input type="text" id="itemLink" name="itemLink" class="easyui-textbox" style="width: 400px"/>
			</td>
		</tr>
		<tr class="mf-line">
		...
		<tr class="mf-line">
			...
			<td class="mf-right">
				<textarea style="width:100%;height:220px;" id="content" name="content"></textarea>
