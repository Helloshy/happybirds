...
<script type="text/javascript">
		...
		var valueFormatter1 = function(value,row,index){
			if(row.remark != '')return '/';
			else return row.value;
		}
</script>
<body>
	...
	<table id="mygrid" style="margin-top: 10px;display: none;width: 100%" class="myResize"
		data-options="url:'<%=thisPath %>searchList.htm?itemType=blue_curreny_get',loadFilter:loadFilter,
		fitColumns:true,animate: true,showFooter: false,onLoadSuccess:gridLoadSuccess,pagination:true,loading:true,rownumbers:true">
		<thead>
			<tr>
				<th data-options="field:'ck',checkbox:true"></th>
				<th data-options="field:'itemName',width:14,align:'center'">规则解释</th>
				<th data-options="field:'v1',width:6,align:'center',formatter:valueFormatter">获得蓝币比例%</th>
				<th data-options="field:'v2',width:6,align:'center',formatter:valueFormatter1">获得蓝币数量</th>
...
<div id="add-dialog" style="width: 400px;height: 350px;" class="easyui-dialog" class="easyui-dialog"  data-options="iconCls:'icon-save',resizable:true,modal:true,
	...
	<table class="mf-table">
		<tr class="mf-line">
			<td class="mf-left">规则解释</td>
			<td class="mf-right" id="itemName"></td>
		</tr>
		<tr class="mf-line">
			<td class="mf-left" id="title"></td>
			<td class="mf-right">
