...
<body>
	...
	<table id="mygrid" style="margin-top: 10px;display: none;width: 100%" class="myResize"
		data-options="url:'<%=thisPath %>searchList.htm?itemType=service',loadFilter:loadFilter,
		fitColumns:true,animate: true,showFooter: false,onLoadSuccess:gridLoadSuccess,pagination:true,loading:true,rownumbers:true">
		<thead>
			<tr>
				<th data-options="field:'ck',checkbox:true"></th>
				<th data-options="field:'itemName',width:10,align:'center'">服务分类</th>
				<th data-options="field:'value',width:10,align:'center'">咨询电话</th>
...
<div id="add-dialog" style="width: 400px;height: 350px;" class="easyui-dialog" class="easyui-dialog"  data-options="iconCls:'icon-save',resizable:true,modal:true,
	...
	<table class="mf-table">
		<tr class="mf-line">
			<td class="mf-left">服务分类</td>
			<td class="mf-right" id="itemName"></td>
		</tr>
		<tr class="mf-line">
			<td class="mf-left">咨询电话</td>
			<td class="mf-right">
