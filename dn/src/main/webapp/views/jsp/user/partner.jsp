...
<body>
	...
	<div id="gridTools" data-options="border:false" style="padding-top: 10px;">
		...
		<span style="margin-left: 40px;">省：<input type="text" id="province1"  name="province" style="width: 100px"/></span>
		<span style="margin-left: 40px;">市：<input type="text" class="easyui-combobox" id="city1" name="city" style="width: 100px"/></span>
		<span style="margin-left: 40px;">邀请码：<input class="easyui-textBox" type="text" name="inviteCode" style="width: 100px"/></span>
		<span style="margin-left: 40px;">邀请人姓名：<input class="easyui-textBox" type="text" name="yqRealName" style="width: 100px"/></span>
		<span>时间: <input type="text" name="startTime" class="easyui-datebox" style="width: 100px"/></span>
		...
		<a href="javascript:void(0)" style="margin-left: 40px;" class="easyui-linkbutton" data-options="iconCls:'icon-undo'" onClick="exportStudent(2)">导出Excel</a>
		</form>
	</div>
	...
	<table id="mygrid" style="margin-top: 10px;display: none;width: 120%" class="myResize"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'grPosition',width:8,align:'center'">个人身份</th>
				<th data-options="field:'dnPosition',width:8,align:'center'">动能身份</th>
				<th data-options="field:'dueDate',width:8,align:'center'">分佣截止期限</th>
				<th data-options="field:'pcd',width:10,align:'center'">省市区</th>
				<th data-options="field:'sex',width:4,align:'center'">性别</th>
...
<div id="add-dialog" style="width: 690px;height: 550px;" class="easyui-dialog" class="easyui-dialog"  data-options="iconCls:'icon-save',resizable:true,modal:true,
	...
	<table class="mf-table">
		<tr class="mf-line">
			...
			<td class="mf-right" colspan="3">
				 <div id="imgdiv"><img id="imgShow" width="260" height="190" /></div>
		...
		<tr class="mf-line">
			...
			<td class="mf-right">
				<input type="text" id="dnPosition" name="dnPosition" class="easyui-combobox" data-options="required:true,editable:false,multiple:true,valueField:'id',textField:'text',
				url:'<%=basePath %>/web/tag/usertag/searchTagTypeList.htm?tagType=动能身份'" style="width: 180px"/>
			</td>
		</tr>
		<tr class="mf-line">
		...
		<tr class="mf-line">
			<td class="mf-left">分佣截止期限</td>
			<td class="mf-right">
				<input type="text" id="dueDate" name="dueDate" class="easyui-datebox" style="width: 180px"/>
			</td>
			<td class="mf-left">上级邀请码</td>
			<td class="mf-right">
				<input type="text" id="sjInviteCode" name="sjInviteCode" class="easyui-textbox" style="width: 180px"/>
			</td>
		</tr>
		<tr class="mf-line">
...
<!-- 详情 -->
<div style="display: none;">
<div id="add-detail" style="width: 850px;height: 680px;" class="easyui-dialog" data-options="iconCls:'icon-save',resizable:true,modal:true,
	...
	<table class="mf-table">
		...
		<tr class="mf-line" style="height: 45px;">
			<td colspan="6">
				...
				<a href="javascript:void(0)" style="margin-left: 70px;width: 80px;height: 30px;" class="easyui-linkbutton" onClick="eacherOrder(1)">讲学申请</a>
			</td>
		</tr>
	</table>
	</form>
