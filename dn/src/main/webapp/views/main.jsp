...
<div id="cc" class="easyui-layout myResizelayout" data-optins="fit:true,border:false" style="width:100%;height:100%;">
	<div data-options="region:'west',title:'功能菜单',border:1" style="width:200px;max-height:90%;overflow-y: true;overflow-x: hidden;">
		<ul id="tt" class="easyui-tree" url="<%=basePath%>web/system/resource/findResourceTree.htm" 
