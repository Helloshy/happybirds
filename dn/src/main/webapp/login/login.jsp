...
<head>
	...
	var login = function(){
		...
		var password = $('#loginForm').find('#pwd').val();
		password = md5(password) ;
		var url = '<%=basePath %>web/system/systemuser/login.htm';
		$.post(url,{userName:userName,pwd:password},function(data){
			if(data != null){
					...
					<form class="form-horizontal" id="loginForm" method="post">
						<fieldset>
							...
							<div class="input-prepend" title="请输入密码" data-rel="tooltip">
								<span class="add-on">密&nbsp;&nbsp;&nbsp;&nbsp;码：<i class="icon-lock"></i></span><input class="input-large span10" name="pwd" id="pwd" type="password" value="123456" />
							</div>
