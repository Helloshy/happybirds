...
public class SmsClientSend {
	...
	public static String url = "http://120.26.85.224:8888/sms.aspx"; 
	public static String userid = "29";
	public static String account = "hy_nxjqm";
	public static String password = "123123123";
	
	
	public static void main(String[] args) {
		String r = sendSms(url, userid, account, password, "18026290650", "【集气猫网络】hahaha");
		String json = Common.xmltoJson(r);
		JSONObject fromObject = JSONObject.fromObject(json);
		String status = (String) fromObject.get("returnstatus");
	...
	public static String sendSms(String mobile, String content){
		String r = sendSms(url, userid, account,password, mobile, content);
		String json = Common.xmltoJson(r);
		JSONObject fromObject = JSONObject.fromObject(json);
		String status = (String) fromObject.get("returnstatus");
		return status;
