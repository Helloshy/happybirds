	...
	<form id="dataFrom" action="${pageContext.request.contextPath}/system/appChart/saveOrUpdate.htm">
	    ...
	    <div class="dialog-1">
	        <div class="layout-1">
	            ...
	            <select class="layout-right" name="districtId">
	            <c:forEach items="${districts}" var="district">
	            		<option value="${district.id}" <c:if test="${district.id ==chart.districtId }">selected="selected"</c:if>>${district.id}</option>
	            	</c:forEach>
	            </select>
	        </div>
	        <div class="layout-1">
	            <span class="layout-left">省份</span>
	            <select class="layout-right" name=province>
	        ...
	        <div class="layout-1">
	            ...
	            <input type="text" name="issueDate" class="layout-right date-picker" value="<fmt:formatDate value="${chart.issueDate}" pattern="yyyy-MM-dd"/>">
	        </div>
	         <div class="layout-1">
