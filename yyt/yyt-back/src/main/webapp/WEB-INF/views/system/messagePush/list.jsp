	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$(grid_selector).jqGrid({
			    url : webRoot + '/system/messagePush/list.htm',
			    mtype : "GET",
			    datatype : "json",
			    colModel : [{
			                label : '标题',
				...
				$("#addFun").click(function(){
					var url = webRoot + "/system/messagePush/addPage.htm";
		        	laybox = layer.open({
		        		title: "新增",
		        		type: 1,
		        		area:["600px","80%"],
				...
				$("#editFun").click(function(){
					...
					var url = webRoot + "/system/messagePush/editPage.htm?id=" + cbox;
					laybox = layer.open({
		        		title: "编辑",
		        		type: 1,
		        		area:["600px","80%"],
		        ...
		        $("#delFun").click(function(){
		        	...
		        	layer.confirm("是否删除？",function(index){
		        		var url = webRoot + "/system/messagePush/delete.htm";
