...
<html>
	...
	<body class="no-skin">
							...
							<div class="widget-body" >
								<div class="widget-main">
									<div class="form-group">
										<div class="col-sm-9">
											<span>联系状态：</span>
						           			<select id="contactStatus" style="width:200px;">
							           			<option value="all">全部</option>
							           			<option value="1">已联系</option>
							           			<option value="0">未联系</option>
						           			</select>
						           			<span style="margin-left:20px;"></span>
								            <input type="text" id="userName" placeholder="输入用户名称查找">
								            &nbsp;&nbsp;&nbsp;
		...
		<script type="text/javascript" src="${ctx}/static/js/system/userApply/list.js"></script>
	</body>
</html>
