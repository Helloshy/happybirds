...
<body>
	<form id="dataFrom" action="${pageContext.request.contextPath}/system/news/save.htm" >
	    ...
	    <div class="dialog-1">
	         ...
	         <div class="layout-1">
	            ...
	            <input type="text" name="link" class="layout-right" placeholder="请输入资讯来源">
	        </div>
	        <div class="layout-1">
	            ...
	            <div class="layout-right ">
		        	<div class="form-group col-md-12 has-feedback" >
					    <div class="col-md-4 input-group">
						    ...
						    <input id="fileText" class="form-control" type="text" style="width:300px;">
	         ...
	         <div class="layout-1">
	         	<a href="javascript:void(0);" id="uploadImg" onclick="$('input[id=file]').click();">
	        ...
	        <div class="layout-1">
	            ...
	            <input type="text" name="title" class="layout-right" placeholder="请输入标题">
	        </div>
	         <div class="layout-1">
	            <span class="layout-left">详情：</span>
	            <textarea style="height: 150px;width: 97%"  rows="80" name="content" cols="8" id="editor_id"></textarea>
	        </div>
	        <div class="layout-1">
	        </div>
	        <div class="btn-box">
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/system/news/add.js"></script>
<script type="text/javascript">
