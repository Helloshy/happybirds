...
<body>
	<form id="dataFrom" action="${pageContext.request.contextPath}/guide/save.htm">
	    ...
	    <div class="dialog-1">
	        ...
	        <div class="layout-1">
	         ...
	         <div class="layout-1">
	            ...
	            <textarea style="height: 190px;width: 97%" name="content" rows="80" cols="8" id="editor_id"></textarea>
	        </div>
	        <div class="btn-box">
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/company/guide/add.js"></script>
</body>
