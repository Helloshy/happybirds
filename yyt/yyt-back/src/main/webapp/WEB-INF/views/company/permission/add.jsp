...
<body>
	<form id="dataFrom" action="${pageContext.request.contextPath}/permission/save.htm">
	    ...
	    <div class="dialog-1">
	        <div class="layout-1">
	            ...
	            <input name="roleName" type="text"  style="width:50%"/>
	        </div>
	        <div class="layout-1">
		        ...
		        <div class="layout-1 clearfix" style="margin-left:50px;">
		        	<span class="layout-left float-left"><input type="checkbox" class="parent resource${res.id }" name="resourceId" value="${res.id }"> ${res.resourceName }：</span>
		        	 ...
		        	 <c:forEach items="${res.menus }" var="menu">
		        	 	<label>
		        			<input type="checkbox" name="resourceId" class="child resource${menu.id }" data-parent="${res.id }" value="${menu.id }">${menu.resourceName }&nbsp;
		        		</label>
		        	</c:forEach>
		        	</div>
		        </div>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/company/permission/add.js"></script>
</body>
