...
<body>
	<form id="dataFrom" action="${pageContext.request.contextPath}/companyHall/save.htm">
	    <div class="dialog-1">
	        ...
	        <div class="layout-1">
	            ...
	            <input type="text" name="hallName" class="layout-right" required="required">
	           
	        </div>
	        <div class="layout-1">
	            <span class="layout-left">负责人：</span>
	            <input name="manager" class="layout-right" required="required" />
	        </div>
	        <div class="layout-1">
	            <span class="layout-left">联络电话：</span>
	             <input name="tel" class="layout-right" required="required"/>
	        </div>
				<div class="layout-1">
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/company/hall/add.js"></script>
</body>
</html>
