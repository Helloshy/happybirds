...
<body>
	<form id="dataFrom" action="${pageContext.request.contextPath}/meter/import/save.htm" method="post">
		<input  name="recordId" type="hidden" value="${resultMap.meterRecordId}"/>
		<input  name="unid" type="hidden" value="${resultMap.id}"/>
	    <div class="dialog-1">
			<div class="layout-1">
			...
			<div class="layout-1">
				...
				<span>当期表字</span>
				<input id="currentCount" type="text" name="currentCount" onchange="countGas(${resultMap.current_count})">
				<span>用气量</span>
				<span id="gasConsum"></span>
			</div>
			<div class="layout-1">
			...
			<div class="layout-1">
				...
				<span >抄表时间</span>
				<input id="recordTime"  class="date-picker" name="recordTime"/>
			</div>
	        <div class="btn-box">
