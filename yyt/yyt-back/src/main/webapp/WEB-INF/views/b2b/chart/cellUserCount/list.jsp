...
<html>
	...
	<body class="no-skin">
				...
				<div class="main-content-inner">
					...
					<!-- 搜索框结束 -->
						...
						<div class="doc-buttons" style="padding: 10px 0;">
							...
							<button type="button" id="exportFun" class="btn btn-sm btn-info">
								<span class="glyphicon glyphicon-pencil" aria-hidden="true" onclick="exportData()">导出表格</span></button>
							</div>
							<div class="col-xs-12">
		...
		<script type="text/javascript" src="${ctx}/static/js/b2b/chart/cellUserCount/list.js"></script>
	</body>
</html>
