	...
	$(function(){
		...
		$(grid_selector).jqGrid({
		    url : webRoot + '/system/systemUser/list.htm',
		    mtype : "GET",
		    datatype : "json",
		    colModel : [{label : 'id',
		                name : 'id',
		...
		$("#addFun").click(function(){
			var url = webRoot + "/system/systemUser/addPage.htm";
        	laybox = layer.open({
        		title: "新增",
        		type: 1,
        		area:["600px","80%"],
		...
		$("#editFun").click(function(){
			...
			var url = webRoot + "/system/systemUser/editPage.htm?id=" + cbox;
			laybox = layer.open({
        		title: "编辑",
        		type: 1,
        		area:["600px","60%"],
        ...
        $("#delFun").click(function(){
        	...
        	layer.confirm("是否删除？",function(index){
        		var url = webRoot + "/system/systemUser/delete.htm";
