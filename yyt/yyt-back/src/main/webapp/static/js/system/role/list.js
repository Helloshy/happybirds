	...
	$(function(){
		...
		$(grid_selector).jqGrid({
			...
			$("#addFun").click(function(){
				var url = webRoot + "/system/role/addPage.htm";
	        	laybox = layer.open({
	        		title: "新增",
	        		type: 1,
	        		area:["600px","280px"],
			...
			$("#editFun").click(function(){
				...
				var url = webRoot + "/system/role/editPage.htm?id=" + cbox;
				laybox = layer.open({
	        		title: "编辑",
	        		type: 1,
	        		area:["600px","280px"],
	        ...
	        $("#delFun").click(function(){
	        	...
	        	layer.confirm("是否删除？",function(index){
	        		var url = webRoot + "/system/role/delete.htm";
            ...
            $("#permission").click(function(){
            	...
            	var url = webRoot + '/system/resource/permission.htm?roleId='+cbox;
            	laybox = layer.open({
            		title : "分配权限",
            		type : 1,
            		area : [ "250px", "60%" ],
