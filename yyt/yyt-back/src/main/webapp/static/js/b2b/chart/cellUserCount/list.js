...
$(function(){
	...
	$(grid_selector).jqGrid({
	    url : webRoot + '/chart/cellUserCount/list.htm',
	    mtype : "GET",
	    datatype : "json",
	    colModel : [{
	                label : '所属公司',
	                ...
	                formatter: function(cellvalue, options, rowObject){
	                	if (cellvalue) return (new Date(cellvalue)).format('yyyy-MM-dd hh:mm:ss')
						else return ''
	                }
	            }],
	            postData:{
...
var exportData = function (beginDate,endDate) {
	var param = getParam();
	window.location.href = webRoot+'/chart/cellUserCount/export.htm?'+'beginDate='+param.beginDate+'&endDate='+param.endDate
}
