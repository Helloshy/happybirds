...
$(function(){
	...
	$(grid_selector).jqGrid({
	    url : webRoot + '/companyHall/list.htm',
	    mtype : "GET",
	    datatype : "json",
	    colModel : [{
		            label : '所属燃气公司',
		...
		$("#addFun").click(function(){
			var url = webRoot + "/companyHall/addPage.htm";
			laybox = layer.open({
        		title: "新增",
        		type: 1,
        		area:["800px","70%"],
        ...
        $("#delFun").click(function(){
        	...
        	layer.confirm("是否删除？",function(index){
        		var url = webRoot + "/companyHall/delete.htm";
		...
		$("#editFun").click(function(){
			...
			var url = webRoot + "/companyHall/editPage.htm?id=" + cbox;
			laybox = layer.open({
				title: "编辑",
				type: 1,
				area:["700px","80%"],
