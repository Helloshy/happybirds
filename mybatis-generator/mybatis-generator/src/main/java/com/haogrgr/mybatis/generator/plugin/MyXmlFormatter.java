...
public class MyXmlFormatter extends DefaultXmlFormatter implements XmlFormatter {
    ...
    private static HashMap<String, Integer> weightMap = new HashMap<String, Integer>();
    {
        ...
        weightMap.put("deleteByEntity", inc++);
        weightMap.put("findAll", inc++);
    }
...
//                System.out.println("o1:" + o1Id + "---- o2:" + o2Id);
                if(o1Id.indexOf("BLOBs") >= 0 || o2Id.indexOf("BLOBs") >= 0) return 1;
                if(o1Id.indexOf("Blob") >= 0 || o2Id.indexOf("Blob") >= 0) return 1;
