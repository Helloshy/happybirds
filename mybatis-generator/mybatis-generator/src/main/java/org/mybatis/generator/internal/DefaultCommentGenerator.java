...
public class DefaultCommentGenerator implements CommentGenerator {
    ...
    public void addComment(XmlElement xmlElement) {
        ...
        String remark = "";
        if("resultMap".equals(elementName)) remark = "表与实体类字段对应";
        else if("sql".equals(elementName)) remark = "表字段名称";
        else if("select".equals(elementName)) remark = "根据ID查询";
        else if("update".equals(elementName)) remark = "更新数据";
        else if("insert".equals(elementName)) remark = "添加数据";
        else if("delete".equals(elementName)) remark = "删除数据";
        
        StringBuilder sb = new StringBuilder();
        sb.append("<!-- ")
        //.append(MergeConstants.NEW_ELEMENT_TAG).append(" do_not_delete_during_merge")
        .append(" 自动生成 ")
        .append(getDateTimeStr("yyyy年MM月dd日", new Date()))
        .append(" " + remark)
        .append(" -->");
